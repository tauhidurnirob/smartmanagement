...
import AuditFormTypeList from '../../modules/audit/audit-form-type/AuditFormTypeList'
import AuditAssignFormProject from '../../modules/audit/audit-form-template/assign-form-project/AuditAssignFormProject'

const TAB_LIST = [
  { id: 'rating-template', label: 'Rating Template' },
  { id: 'form-type', label: 'Form Type' },
  // { id: 'assign-form-project', label: 'Assign Form Project' },
]

const AuditRatingView = () => {
  ...
  return (
    <Box>
      ...
      <Box mt={3.75}>
        ...
        {selectedTab === 1 && <AuditFormTypeList />}
        {selectedTab === 2 && <AuditAssignFormProject />}
      </Box>
    </Box>
  )
}

export default AuditRatingView
