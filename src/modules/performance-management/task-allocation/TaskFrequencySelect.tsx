...
import { TASK_FREQUENCIES } from '../../../helpers/constants'
  ...
  return (
    <Box sx={{ ...(sx || {}) }}>
      ...
      <InfiniteMultipleSelect
        ...
        limit={10}
        labelForAll={
          placeholder ? placeholder : disableAllSelect ? 'Select Frequency' : 'All Frequencies'
        }
...
export default TaskFrequencySelect
