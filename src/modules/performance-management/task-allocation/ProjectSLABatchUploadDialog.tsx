...
const ProjectSLABatchUploadDialog: FC<IProps> = (props) => {
      ...
      <DialogContent sx={{ pt: 6.25, px: 6, pb: 8.25 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Box>
            ...
            >
              Use the provided template to import project SLA from excel format
            </Typography>
          </Box>
          <Box
            sx={{
...
export default ProjectSLABatchUploadDialog
