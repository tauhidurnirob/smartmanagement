...
import AlertListByProjectMoreFilterModal from './AlertListByProjectMoreFilterModal'
import alertSlice from '../../store/slices/alert'
import { useDispatch } from 'react-redux'
import { ENotificationMoreFilterKeys, INotificationListMoreFilters } from '../../types/notification'

interface IProps {
  filters: IAlertListByProjectFilters
}

const NotificationListByProjectFilterbar: FC<IProps> = ({ filters }) => {
  ...
  return (
    <Card sx={{ pt: 3.5, px: 3.75, pb: 3.75 }}>
      ...
      <AlertListByProjectMoreFilterModal
