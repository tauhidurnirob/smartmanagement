...
interface IProps {
  ...
  onClose: () => void
  onApply: (filters: IAlertListByProjectFilters) => void
}

const AlertListByProjectMoreFilterModal: FC<IProps> = ({
  open,
  filters: inFilters,
  onClose,
  onApply,
}) => {
  const [filters, setFilters] = useState<IAlertListByProjectFilters>({
    text: '',
    projects: [],
    locations: [],
    buildings: [],
...
export default AlertListByProjectMoreFilterModal
