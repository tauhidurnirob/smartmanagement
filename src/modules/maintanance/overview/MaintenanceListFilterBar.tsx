...
import MaintenanceListMoreFilterModal from './MaintenanceListMoreFilterModal'
...
const MaintenanceListFilterbar: FC<IProps> = ({ filters, onChange }) => {
  ...
  return (
    <Card sx={{ pt: 5.5, px: 5, pb: 5 }}>
      ...
      <MaintenanceListMoreFilterModal
...
export default MaintenanceListFilterbar
