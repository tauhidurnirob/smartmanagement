...
interface IProps {
  ...
  onClose: () => void
  onApply: (filters: IMaintenanceListFilters) => void
}

const MaintenanceScheduleListMoreFilterModal: FC<IProps> = ({
  open,
  filters: inFilters,
  onClose,
  onApply,
...
export default MaintenanceScheduleListMoreFilterModal
