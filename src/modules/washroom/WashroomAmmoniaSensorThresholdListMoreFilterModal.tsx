...
interface IProps {
  open: boolean
  filters: IWashroomAmmoniaSensorThresholdListFilters
  onClose: () => void
  onApply: (filters: IWashroomAmmoniaSensorThresholdListFilters) => void
}

const WashroomAmmoniaSensorThresholdListMoreFilterModal: FC<IProps> = ({
  open,
  filters: inFilters,
  onClose,
  onApply,
...
export default WashroomAmmoniaSensorThresholdListMoreFilterModal
