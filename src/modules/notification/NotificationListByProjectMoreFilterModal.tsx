...
interface IProps {
  open: boolean
  filters: INotificationListMoreFilters
  onClose: () => void
  onApply: (filters: INotificationListMoreFilters) => void
}

const NotificationListByProjectMoreFilterModal: FC<IProps> = ({
  open,
  filters: inFilters,
  onClose,
  onApply,
}) => {
  const [filters, setFilters] = useState<INotificationListMoreFilters>({
    buildings: [],
    levels: [],
    areas: [],
    units: [],
...
export default NotificationListByProjectMoreFilterModal
