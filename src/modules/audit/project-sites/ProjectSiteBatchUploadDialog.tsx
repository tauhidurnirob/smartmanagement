...
const ProjectSiteBatchUploadDialog: FC<IProps> = (props) => {
  const { onClose, open } = props

  const [downloadTemplate] = Api.useDownloadTemplateProjectSiteUploadMutation()
  const [batchUpload, {isLoading: batchUploadLoading}] = Api.useBatchUploadProjectSiteMutation()
...
export default ProjectSiteBatchUploadDialog
