  ...
  return (
    <Box>
      <Stack direction={'row'} justifyContent={'space-between'} alignItems={'center'} gap={2} flexWrap={'wrap'} >
        <Typography variant="h4">{multiple ? 'Multiple' : 'Single'} Choice Field</Typography>
      ...
      <Box>
        <Stack direction={'row'} gap={1}>
          <Typography variant="h4">{multiple ? 'Multiple' : 'Single'} Choice Option</Typography>
          <AddIcon
            fontSize="medium"
