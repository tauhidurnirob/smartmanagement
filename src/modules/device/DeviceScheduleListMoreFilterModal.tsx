...
interface IProps {
  ...
  onClose: () => void
  onApply: (filters: IDeviceScheduleListFilters) => void
}

const DeviceScheduleListMoreFilterModal: FC<IProps> = ({
  open,
  filters: inFilters,
  onClose,
  onApply,
}) => {
  const [filters, setFilters] = useState<IDeviceScheduleListFilters>({
    search: '',
    projects: [],
    locations: [],
    buildings: [],
...
export default DeviceScheduleListMoreFilterModal
