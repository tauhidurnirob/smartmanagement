...
interface IProps {
  ...
  onClose: () => void
  onApply: (filters: IDeviceLinkageListFilters) => void
}

const DeviceLinkageListMoreFilterModal: FC<IProps> = ({
  open,
  filters: inFilters,
  onClose,
  onApply,
}) => {
  const [filters, setFilters] = useState<IDeviceLinkageListFilters>({
    search: '',
    projects: [],
    locations: [],
    buildings: [],
...
export default DeviceLinkageListMoreFilterModal
