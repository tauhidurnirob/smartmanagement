...
import { FEEDBACK_TYPE_LIST } from '../../../helpers/constants'
...
const FeedbackTypeSelect = ({ selected, hiddenLabel, onChange, showErrorMessage, error, errorMessage, textColor }: IProps) => {
