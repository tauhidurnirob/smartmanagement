...
import FeedbackListMoreFilterModal from './FeedbackListMoreFilterModal'
import { IFeedbackListFilters } from '../../../types/feedback'

interface IProps {
  filters: IFeedbackListFilters
  onChange: (filters: IFeedbackListFilters) => void
}

const FeedbackListFilterbar: FC<IProps> = ({ filters, onChange }) => {
  ...
  const handleMoreFilters = (inFilters: IFeedbackListFilters) => {
    onChange({ ...inFilters })
...
export default FeedbackListFilterbar
