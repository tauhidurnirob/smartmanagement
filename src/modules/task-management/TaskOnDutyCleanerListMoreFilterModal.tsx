...
interface IProps {
  ...
  onClose: () => void
  onApply: (filters: ITaskOnDutyCleanderListFilters) => void
}

const TaskOnDutyCleanerListMoreFilterModal: FC<IProps> = ({
  open,
  filters: inFilters,
  onClose,
  onApply,
...
export default TaskOnDutyCleanerListMoreFilterModal
