...
import { ITaskOnDutyCleanderListFilters } from '../../types/task'
import TaskListMoreFilterModal from './TaskListMoreFilterModal'
import LocationSelect from '../location/LocationSelect'

interface IProps {
  filters: ITaskOnDutyCleanderListFilters
  onChange: (filters: ITaskOnDutyCleanderListFilters) => void
}

const TaskOnDutyCleanderListFilterbar: FC<IProps> = ({ filters, onChange }) => {
  ...
  const handleMoreFilters = (inFilters: ITaskOnDutyCleanderListFilters) => {
    onChange({ ...inFilters })
...
export default TaskOnDutyCleanderListFilterbar
