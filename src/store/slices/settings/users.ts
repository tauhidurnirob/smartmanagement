...
interface SettingUsersFilterState {
  page: number
  limit: number
...
const initialState: SettingUsersFilterState = {
  page: 1,
...
const settingUsersFilterSlice = createSlice({
  name: 'settingUsersFilter',
  initialState,
  reducers: {
...
export default settingUsersFilterSlice
