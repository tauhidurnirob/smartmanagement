...
interface AuditScheduleRecycleState {
  page: number
  limit: number
...
const initialState: AuditScheduleRecycleState = {
  page: 1,
...
const auditScheduleRecycleSlice = createSlice({
  name: 'auditScheduleRecycle',
  initialState,
  reducers: {
...
export default auditScheduleRecycleSlice
