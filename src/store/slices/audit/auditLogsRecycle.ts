...
interface AuditLogsRecycleState {
  page: number
  limit: number
...
const initialState: AuditLogsRecycleState = {
  page: 1,
...
const auditLogRecycleSlice = createSlice({
  name: 'auditLogsRecycle',
  initialState,
  reducers: {
...
export default auditLogRecycleSlice
